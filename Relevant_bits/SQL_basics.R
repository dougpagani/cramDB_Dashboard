...
# three primary parts of a SQL-query
# SELECTION -- specific rows
# PROJECTION -- specific columns (every column is a dimension, as if it were in a multi-dimensional space)
# JOIN
# 
# dimensions have domains
# 
# Queries, generic